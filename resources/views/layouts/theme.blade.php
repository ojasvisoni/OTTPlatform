...
<body>
  ...
  <div class="loading">
    ...
    <div class="loading-text">
      ...
      <span class="loading-text-words">{{__('I')}}</span>
...
<!--              <a href="#" title="{{$w_title}}"><img src="{{url('images/logo/'.$logo)}}" class="img-responsive"
                  alt="{{$w_title}}"></a>-->
              <a href="{{url('/')}}" title="{{$w_title}}"><img src="{{url('images/logo/logo.png')}}" class="img-responsive"
                  alt="{{$w_title}}"></a>
              @else
              <a href="{{url('/')}}" title="{{$w_title}}"><img src="{{url('images/logo/logo.png')}}" class="img-responsive"
                  alt="{{$w_title}}"></a>
              ...
              @if(isset($menuh) && count($menuh) > 0)
                @foreach ($menuh as $menus)
                  @if($auth && getSubscription()->getData()->subscribed == true)
                    ...
                    <li>
                      <a class="{{ Nav::hasSegment($menus->slug) }} {{$menus->name}}" href="{{url('/', $menus->slug)}}"  title="{{$menus->name}}">
                        {{ $menus->name }}
                      </a>
                    </li>
                  @else
                    ...
                    <li>
                      <a class="{{ Nav::hasSegment($menus->slug) }} {{$menus->name}}" href="{{url('/guest', $menus->slug)}}"  title="{{$menus->name}}">
                        {{ $menus->name }}
                      </a>
                    </li>
                  @endif
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                          <div class="admin-wallet-block">
                            <ul>
                              <li><img src="{{url('/images/wallet.png')}}" class="img-fluid" alt="">
                                {{__('Wallet Balance')}}
                                <span>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                          <div class="admin-money-block text-right">
                            <a href="{{route('user.wallet.show')}}">
                              <ul>
                                <li><img src="{{url('/images/wallet.png')}}" class="img-fluid" alt=""></li>
                                <li>{{__('Add Money')}}</li>
                              </ul>
                            </a>
                          </div>
                        ...
                        <ul class="admin-list">
                          ...
                          <li>
                            <a href="{{url('admin/movies')}}" target="_blank">
                              {{__('staticwords.ProducerDashboard')}}</a>
                          </li>
                          @endif
...
<!--                      <div class="col-sm-6 col-lg-6">
                        <ul>
                          ...
                          <li><a
                              href="{{url('/manageprofile/mus/'.Auth::user()->id)}}">{{__('staticwords.manageprofile')}}</a>
                          </li>
                          @endif
                          @php
              ...
              <li class="sign-in-block sign-in-block-one sign-in-block-two mrgn-rt-20">
                  <a class="sign-in" href="{{url('login')}}"><i class="flaticon-login"></i> {{__('staticwords.signin')}}</a>
              </li>
              <li class="sign-in-block sign-in-block-one ">
                  <a class="sign-in" href="{{url('register')}}"><i class="flaticon-profile"></i>{{__('staticwords.register')}}</a>
              </li>
              @endauth
            </ul>
          </div>
  ...
  <div class="small-screen-navigation">
    <nav class="sidenav" id="mySidenav" role="navigation">
      ...
      <div class="wrapper-heading"><img src="{{url('images/logo/logo.png')}}" /></div>
      <ul class="nav sidebar-nav">
        ...
        <li class="sign-in-block">
          <div class="dropdown prime-dropdown">
            ...
            <ul class="dropdown-menu prime-dropdown-menu">
              ...
              @endif
              @if(isset(Auth::user()->paypal_subscriptions) && $subscribed == 1)
              <li><a href="{{url('/manageprofile/mus/'.Auth::user()->id)}}">{{__('staticwords.manageprofile')}}</a>
              </li>
              @endif
              @php
        ...
        <li class="sign-in-block sign-in-block-one sign-in-block-two"><a class="sign-in" href="{{url('login')}}"><i
              class="flaticon-login"></i> {{__('staticwords.signin')}}</a></li>
        <li class="sign-in-block sign-in-block-one "><a class="sign-in" href="{{url('register')}}"><i
              class="flaticon-profile"></i>{{__('staticwords.register')}}</a></li>
        @endauth
      </ul>
    </nav>
  ...
  <div class="purchase-sticky">
    <p>{{__('staticwords.pleasesubscribetoaplan')}} &nbsp;<a href="{{url('account/purchaseplan')}}"><button
          class="btn btn-sm text-white agree_btn js-cookie-consent-agree cookie-consent__agree">{{__('staticwords.clickhere')}}</button></a>
    </p>
  </div>
  @endif
  @endif
    ...
    <div class="container-fluid">
      ...
      <div class="text-center app-image">
            ...
            <a href="{{$appstore}}" target="_blank"> 
                <img src="{{url('images/app_store_download.png')}}">
            </a>
            @endif
            @if($isplay==1 && $isplay != NULL)
            <a href="{{$playstore}}" target="_blank">
                <img src="{{url('images/google_play_download.png')}}">
            </a>
            @endif
      </div>
