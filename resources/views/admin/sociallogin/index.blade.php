...
@section('title',__('adminstaticwords.SocialLogin'))
@section('content')
...
<div class="container">
	<div class="box-body">
		...
		<div class="col-md-6">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-facebook"></i> {{__('adminstaticwords.FacebookLoginSetting')}}
				</div>
		    ...
		    <label for="">{{__('adminstaticwords.EnableFacebookLogin')}} </label>
			...
			" }}">
				<div class="form-group">
			<label for="">{{__('adminstaticwords.FacebookClientID')}}</label>
			<input type="text" value="{{ $env_files['FACEBOOK_CLIENT_ID'] }}" name="FACEBOOK_CLIENT_ID" class="form-control">
			</div>
			<div class="search form-group">
				<label for="">{{__('adminstaticwords.FacebookSecretID')}}</label>	
			...
			<div class="form-group">
				<label for="">{{__('adminstaticwords.FacebookRedirectURL')}}</label>
			...
			<button type="submit" class="btn btn-md btn-primary">
				<i class="fa fa-save"></i> {{__('adminstaticwords.Save')}}
			</button>
			</form>
				</div>
			</div>
		...
		<div class="col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-google"></i> {{__('adminstaticwords.GoogleLoginSetting')}}
				</div>
			...
			<div class="form-group">
				<label for="">{{__('adminstaticwords.EnableGoogleLogin')}} </label>
			...
			" }}">
				<div class="form-group">
				<label for="">{{__('adminstaticwords.GoogleClientID')}}</label>
			<input type="text" value="{{ $env_files['GOOGLE_CLIENT_ID'] }}" name="GOOGLE_CLIENT_ID" class="form-control" >
			</div>
			
			
			<div class="search form-group">
			<label for="">{{__('adminstaticwords.GoogleSecretID')}}</label>
			...
			<div class="form-group">
				<label for="">{{__('adminstaticwords.GoogleRedirectURL')}}</label>
		...
		<div class="col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-gitlab"></i> {{__('adminstaticwords.GitLabLoginSetting')}}
				</div>
			...
			<div class="form-group">
				<label for="">{{__('adminstaticwords.EnableGITLABLogin')}} </label>
			...
			" }}" id="git_lab_box">
				<div class="form-group">
		    	<label for="">{{__('adminstaticwords.GITLABClientID')}}</label>
				<input type="text" value="{{ $env_files['GITLAB_CLIENT_ID'] }}" name="GITLAB_CLIENT_ID" class="form-control" >
		    	</div>
			
			
				<div class="search form-group">
					<label for="">{{__('adminstaticwords.GITLABSecretID')}}</label>
				...
				<div class="form-group">
					<label for="">{{__('adminstaticwords.GITLABRedirectURL')}}</label>
		...
		<div class="col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-amazon"></i> {{__('adminstaticwords.AmazonLoginSetting')}}
				</div>
			...
			<div class="form-group">
				<label for="">{{__('adminstaticwords.EnableAMAZONLogin')}} </label>
			...
			" }}" id="amazon_lab_box">
				<div class="form-group">
		    	<label for="">{{__('adminstaticwords.AMAZONLOGINID')}}</label>
				...
				<div class="search form-group">
					<label for="">{{__('adminstaticwords.AMAZONLoginSecret')}}</label>
				...
				<div class="form-group">
					<label for="">{{__('adminstaticwords.AMAZONRedirectURL')}}</label>
