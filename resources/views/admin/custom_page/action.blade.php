<div class="admin-table-action-block">
  @can('pages.edit')
    <a href="{{route('custom_page.edit', $id)}}" data-toggle="tooltip" data-original-title="{{__('adminstaticwords.Edit')}}" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
  @endcan
  @can('pages.delete')
