...
@section('title',__('adminstaticwords.EditCustomPage'))
@section('content')
  <div class="admin-form-main-block mrg-t-40">
     <h4 class="admin-form-text">
      @can('pages.view')
      <a href="{{url('admin/custom_page')}}" data-toggle="tooltip" data-original-title="{{__('adminstaticwords.GoBack')}}" class="btn-floating"><i class="material-icons">reply</i></a> 
      @endcan
      {{__('adminstaticwords.EditCustomPage')}}</h4> 
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-12">
          <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
              {!! Form::label('title', __('adminstaticwords.CustomPageTitle')) !!} - <p class="inline info">{{__('adminstaticwords.EnterCustomPageTitle')}}</p>
