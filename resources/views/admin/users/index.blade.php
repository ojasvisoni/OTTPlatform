...
@section('title',__('adminstaticwords.AllUsers'))
@section('content')
  <div class="content-main-block mrg-t-40">
    <div class="admin-create-btn-block">
      @can('users.create')
        <a href="{{route('users.create')}}" class="btn btn-danger btn-md"><i class="material-icons left">add</i> {{__('adminstaticwords.CreateUser')}}</a>
      @endcan
      <!-- Delete Modal -->
      @can('users.delete')
