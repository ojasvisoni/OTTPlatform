<div class="admin-table-action-block">
  @can('menu.edit')
    <a href="{{route('menu.edit', $id)}}" data-toggle="tooltip" data-original-title="{{__('adminstaticwords.Edit')}}" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
  @endcan
  @can('menu.delete')
