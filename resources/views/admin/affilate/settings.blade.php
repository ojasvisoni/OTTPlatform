      ...
      @csrf
        ...
        <div class="col-md-12">
          <div class=" form-group{{ $errors->has('about_system') ? ' has-error' : '' }}">
            {!! Form::label('about_system', __('adminstaticwords.Description')) !!} - <p class="inline info">{{__('Some description of your affiliate system that how it gonna work?')}}</p>
          ...
          <div class="bootstrap-checkbox form-group{{ $errors->has('enable_affilate') ? ' has-error' : '' }}">
            ...
            <div class="col-md-5 pad-0">
              <div class="make-switch">
                {!! Form::checkbox('enable_affilate', 1, (isset($af_settings) && $af_settings->enable_affilate == 1 ? 1 : 0), ['class' => 'bootswitch', "data-on-text"=>__('adminstaticwords.On'), "data-off-text"=>__('adminstaticwords.OFF'), "data-size"=>"small"]) !!}
              </div>
            </div>
