...
@section('content')
  <div class="admin-form-main-block mrg-t-40">
    ...
    <h4 class="admin-form-text">
      @can('actor.view')
        <a href="{{url('admin/actors')}}" data-toggle="tooltip" data-original-title="{{__('adminstaticwords.GoBack')}}" class="btn-floating"><i class="material-icons">reply</i></a> 
      @endcan 
      {{__('adminstaticwords.CreateActor')}}
    </h4>
