...
<div class="admin-form-main-block mrg-t-40">
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>{{__('adminstaticwords.MakeSureYouHaveAddedYoutubeAPIKeyIn')}} <a
              href="{{url('admin/api-settings')}}">{{__('adminstaticwords.APISettings')}}</a></p>
          @endif
                ...
                <div class="container-4">
                  <form action="" method="post" name="hyv-yt-search" id="hyv-yt-search">
                    <input type="search" name="hyv-search" id="hyv-search"
                      placeholder="{{__('adminstaticwords.Search')}}..." class="ui-autocomplete-input"
                      autocomplete="off">
                ...
                <div>
                  ...
                  <div class="btn-group" role="group" aria-label="...">
                    <button type="button" id="pageTokenPrev" value=""
                      class="btn btn-default">{{__('adminstaticwords.Prev')}}</button>
                    <button type="button" id="pageTokenNext" value=""
                      class="btn btn-default">{{__('adminstaticwords.Next')}}</button>
                  </div>
                </div>
  ...
  <h4 class="admin-form-text">
    ...
    @endcan
    {{__('adminstaticwords.ManageEpisodes')}} <span>{{__('adminstaticwords.Of')}} {{$season->tvseries->title}} Season
      {{$season->season_no}}
      @if ($season->tmdb == 'Y')
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>{{__('adminstaticwords.MakeSureYouHaveAddedVimeoAPIKeyIn')}} <a
              href="{{url('admin/api-settings')}}">{{__('adminstaticwords.APISettings')}}</a></p>
          @endif
  ...
  <div class="admin-create-btn-block">
    <a id="createButton" onclick="showCreateForm()" class="btn btn-danger btn-md"><i class="material-icons left">add</i>
      {{__('adminstaticwords.CreateEpisode')}}</a>
      ...
      <div class="admin-form-block z-depth-1">
        <div id="createForm" class="create-form">
          ...
          <div class="form-group{{ $errors->has('duration') ? ' has-error' : '' }}">
            {!! Form::label('duration', __('adminstaticwords.Duration')) !!} <p class="inline info">
              -{{__('adminstaticwords.InMinutes')}} (exa. 60)</p>
          ...
          <div class="upload-image-main-block" style="display: none;">
            <div class="row">
              ...
              <div class="form-group{{ $errors->has('thumbnail') ? ' has-error' : '' }} input-file-block">
                {!! Form::label('thumbnail',__('adminstaticwords.Thumbnail')) !!} - <p class="info">
                  {{__('adminstaticwords.HelpBlockText')}}</p>
                ...
                <label for="thumbnail" class="btn btn-danger js-labelFile" data-toggle="tooltip"
                  data-original-title="{{__('adminstaticwords.Thumbnail')}}">
                  <i class="icon fa fa-check"></i>
                  <span class="js-fileName">{{__('adminstaticwords.ChooseAFile')}}</span>
                </label>
          ...
          <div class="form-group{{ $errors->has('selecturl') ? ' has-error' : '' }}">
            ...
            <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top"
              title="{{__('adminstaticwords.PleaseSelectOneOfTheOptionsToAddVideo')}}"></i>
            ...
            'customurl'=>__('adminstaticwords.CustomURLYoutubeURLVimeoURL'),'multiqcustom' =>
            __('adminstaticwords.MultiQualityCustomURLAndURLUpload')), null, ['class' => 'form-control
          ...
          <div id="ifbox" style="display: none;" class="form-group">
            <label for="iframeurl">{{__('adminstaticwords.IframeURLAndEmbedURL')}}: </label> <a data-toggle="modal"
          ...
          <div style="display: none;" id="custom_url">
            ...
            <div class="row">
              ...
              <div class="col-md-5">
                {!! Form::label('upload_video', __('adminstaticwords.UploadVideoIn360p')) !!} - <p class="inline info">
                  {{__('adminstaticwords.ChooseAVideo')}}</p>
                <div class="input-group">
            ...
            <div class="form-group{{ $errors->has('url_480') ? ' has-error' : '' }}">
              <div class="row">
                ...
                <div class="col-md-5">
                  ...
                  {!! Form::label('upload_video',__('adminstaticwords.UploadVideoIn480p')) !!} - <p class="inline info">
                    {{__('adminstaticwords.ChooseAVideo')}}</p>
                  <div class="input-group">
            ...
            <div class="form-group{{ $errors->has('url_720') ? ' has-error' : '' }}">
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  {!! Form::label('upload_video', 'UploadVideoIn720p') !!} - <p class="inline info">
                    {{__('adminstaticwords.ChooseAVideo')}}</p>
                  <div class="input-group">
            ...
            <div class="form-group{{ $errors->has('url_1080') ? ' has-error' : '' }}">
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  {!! Form::label('upload_video', __('adminstaticwords.UploadVideoIn1080p')) !!} - <p
          ...
          <div class="modal fade" id="embdedexamp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p style="font-size: 15px;"><b>{{__('adminstaticwords.Youtube')}}:</b>
                    {{__('adminstaticwords.YoutubeUrlLink')}} </p>

                  <p style="font-size: 15px;"><b>{{__('adminstaticwords.GoogleDrive')}}:</b>
                    {{__('adminstaticwords.GoogleDriveLink')}}</p>

                  <p style="font-size: 15px;"><b>{{__('adminstaticwords.Openload')}}:</b>
                    {{__('adminstaticwords.OpenloadLink')}} </p>

                  <p style="font-size: 15px;"><b>{{__('adminstaticwords.Note')}}:</b>
                    {{__('adminstaticwords.DoNotInclude')}} &lt;iframe&gt; {{__('adminstaticwords.TagBeforeURL')}}</p>
                </div>
          ...
          <div id="ready_url" style="display: none;"
            ...
            <p class="inline info"> - {{__('adminstaticwords.PleaseEnterYourVideoUrl')}}</p> <button type="button"
          ...
          <div style="display: none;" class="subtitle-box">
            ...
            <table class="table table-bordered" id="dynamic_field">
              <tr>
                ...
                <td>
                  <input type="text" name="sub_lang[]" placeholder="{{__('adminstaticwords.SubtitleLanguage')}}"
          ...
          <div id="custom_dtl" class="custom-dtl">
            <div class="form-group{{ $errors->has('released') ? ' has-error' : '' }}">
              {!! Form::label('released', __('adminstaticwords.Released')) !!} <p class="inline info">-
                {{__('adminstaticwords.ReleaseDate')}}</p>
              ...
              <td>
                <div class="admin-table-action-block side-table-action">
                  ...
                  <a href="{{route('episode.link', $episode->id)}} " data-toggle="tooltip"
                    data-original-title="{{__('adminstaticwords.links')}}" class="btn-success btn-floating"><i
                      class="material-icons">link</i></a>
                  @endcan
                  @can('tvseries.edit')
                  <a href="{{route('edit_episodes',['id'=>$season->id,'ep_id'=>$episode->id])}}" data-toggle="tooltip"
                    data-original-title="{{__('adminstaticwords.Edit')}}" class="btn-info btn-floating"><i
