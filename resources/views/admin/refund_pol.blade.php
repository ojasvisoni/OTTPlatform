...
@section('title',__('adminstaticwords.RefundPolicy'))
@section('content')
  <div class="admin-form-main-block mrg-t-40">
    <h4 class="admin-form-text">{{__('adminstaticwords.RefundPolicyText')}}</h4>
    @if ($config)
      <div class="admin-form-block z-depth-1">
        {!! Form::model($config, ['method' => 'PATCH', 'route' => 'refund_pol']) !!}
        <div class="form-group{{ $errors->has('refund_pol') ? ' has-error' : '' }}">
          {!! Form::label('refund_pol', __('adminstaticwords.RefundPolicyText')) !!}
