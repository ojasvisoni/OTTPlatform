<div class="admin-table-action-block">
  @can('label.edit')
    <a href="{{route('label.edit', $id)}}" data-toggle="tooltip" data-original-title="{{__('adminstaticwords.Edit')}}" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
  @endcan
  @can('label.delete')
