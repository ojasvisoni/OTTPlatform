            ...
            <div class="col-md-12">
              <div class="bootstrap-checkbox form-group{{ $errors->has('enable_wallet') ? ' has-error' : '' }}">
                ...
                <div class="col-md-5 pad-0">
                  <div class="make-switch">
                    {!! Form::checkbox('enable_wallet', 1, (isset($wallet) && $wallet->enable_wallet == 1 ? 1 : 0), ['class' => 'bootswitch', "data-on-text"=>__('adminstaticwords.On'), "data-off-text"=>__('adminstaticwords.OFF'), "data-size"=>"small"]) !!}
                  </div>
                </div>
              ...
              <div class="col-md-4">
                <div class="bootstrap-checkbox form-group{{ $errors->has('stripe_enable') ? ' has-error' : '' }}">
                  ...
                  <div class="col-md-5 pad-0">
                    <div class="make-switch">
                      {!! Form::checkbox('stripe_enable', 1, (isset($wallet) && $wallet->stripe_enable == 1 ? 1 : 0), ['class' => 'bootswitch', "data-on-text"=>__('adminstaticwords.On'), "data-off-text"=>__('adminstaticwords.OFF'), "data-size"=>"small"]) !!}
                    </div>
              ...
              <div class="col-md-4">
                <div class="bootstrap-checkbox form-group{{ $errors->has('paytm_enable') ? ' has-error' : '' }}">
                  ...
                  <div class="col-md-5 pad-0">
                    <div class="make-switch">
                      {!! Form::checkbox('paytm_enable', 1, (isset($wallet) && $wallet->paytm_enable == 1 ? 1 : 0), ['class' => 'bootswitch', "data-on-text"=>__('adminstaticwords.On'), "data-off-text"=>__('adminstaticwords.OFF'), "data-size"=>"small"]) !!}
                    </div>
              ...
              <div class="col-md-4">
                <div class="bootstrap-checkbox form-group{{ $errors->has('paypal_enable') ? ' has-error' : '' }}">
                  ...
                  <div class="col-md-5 pad-0">
                    <div class="make-switch">
                      {!! Form::checkbox('paypal_enable', 1, (isset($wallet) && $wallet->paypal_enable == 1 ? 1 : 0), ['class' => 'bootswitch', "data-on-text"=>__('adminstaticwords.On'), "data-off-text"=>__('adminstaticwords.OFF'), "data-size"=>"small"]) !!}
                    </div>
