<div class="admin-table-action-block">
  @can('package-feature.edit')
    <a href="{{route('package_feature.edit', $id)}}" data-toggle="tooltip" data-original-title="{{__('adminstaticwords.Edit')}}" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
  @endcan
