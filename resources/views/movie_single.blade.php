                    ...
                    @if(checkInMovie($movie) == true && isset($movie->video_link)) 
                      @if($movie->maturity_rating == 'all age' || $age>=str_replace('+', '',$movie->maturity_rating))
                        ...
                        @else
                          ...
                          <a href="{{route('watchmovie',$movie->id)}}" class="watch-trailer-btn iframe btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('staticwords.playnow')}}</span>
                            </a>
                            
                        @endif
                      @else

                        <a onclick="myage({{$age}})"  class="watch-trailer-btn btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('staticwords.playnow')}}</span>
                        </a>
              ...
              @php
                if($movie->thumbnail != NULL){
                  $content = @file_get_contents(public_path() . 'images/movies/thumbnails/' . $movie->thumbnail);
                    if($content){
                      $image = 'images/movies/thumbnails/'.$movie->thumbnail;
                    }else{
                 ...
                 @if($auth && getSubscription()->getData()->subscribed == true)
                  @if(isset($season->episodes[0]) && checkInTvseries($season->tvseries) == true && isset($season->episodes[0]->video_link))
                    @if($season->tvseries->age_req =='all age' || $age>=str_replace('+', '',$season->tvseries->age_req))
                      ...
                      @else
                        <a href="{{ route('watchTvShow',$season->id)  }}" class="watch-trailer-btn iframe btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('staticwords.playnow')}}</span></a>
                      @endif
                    @else
                      <a  onclick="myage({{$age}})" class="watch-trailer-btn btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('staticwords.playnow')}}</span></a>
                    @endif
                  @endif
                ...
                <div class="row">
                  ...
                  <div class="col-lg-10">
                    ...
                    @if(isset($single_series) && $single_series->is_upcoming != 1)
                      @if($single_series->maturity_rating == 'all age' || $age>=str_replace('+', '',$single_series->maturity_rating))
                        ...
                        @else
                          ...
                          <a href="{{route('watchmovie',$single_series->id)}}" class="watch-trailer-btn iframe btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('staticwords.playnow')}}</span>
                            </a>
                    ...
                    @if(isset($single_series->multilinks) && count($single_series->multilinks) > 0 )   
                      @if(Auth::user() && getSubscription()->getData()->subscribed == true)
                        @if(in_array(1, $mlc))
                           <button type="button" class="btn btn-sm btn-default watch-trailer-btn download-btn" data-toggle="collapse" data-target="#downloadmovie{{$single_series->id}}">{{__('staticwords.download')}}</button>
                  ...
                  <div class="col-lg-10">
                    ...
                    <div class="des-btn-block des-in-list">
                      ...
                      @if(isset($series) && $series->is_upcoming != 1)
                        @if($series->maturity_rating == 'all age' || $age>=str_replace('+', '',$series->maturity_rating))
                          ...
                          @else
                            ...
                            <a href="{{route('watchmovie',$series->id)}}" class="iframe watch-trailer-btn btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text">{{__('staticwords.playnow')}}</span>
                              </a>
                        ...
                        @if($series->trailer_url != null || $series->trailer_url != '')
                          <a href="{{ route('watchTrailer',$series->id)  }}" class="iframe watch-trailer-btn btn btn-default">{{__('staticwords.watchtrailer')}}</a>
                        @endif
                      @else
                         @if($series->trailer_url != null || $series->trailer_url != '')
                          <a href="{{ route('guestwatchtrailer',$series->id)  }}" class="iframe watch-trailer-btn btn btn-default">{{__('staticwords.watchtrailer')}}</a>
                        @endif
                      @endif
                      @if($catlog ==0 && getSubscription()->getData()->subscribed == true)
                        @if (isset($wishlist_check->added))
                      ...
                      @if(isset($series->multilinks) && count($series->multilinks) > 0 )   
                        @if(Auth::user() && getSubscription()->getData()->subscribed == true)
                          @if(in_array(1, $mlc))
                             <button type="button" class="btn btn-sm btn-default watch-trailer-btn download-btn" data-toggle="collapse" data-target="#downloadmovie{{$series->id}}">{{__('staticwords.download')}}</button>
                      ...
                      @if(isset($episode->multilinks) &&  count($episode->multilinks) >0)
                        @if(Auth::user() && getSubscription()->getData()->subscribed == true)
                          @if(in_array(1, $elc))
                           ...
                           <button type="button" class="btn-default watch-trailer-btn" data-toggle="collapse" data-target="#downloadtvseries{{$episode->id}}">{{__('staticwords.download')}}</button>
                        ...
                        <div class="des-btn-block">
                          @if($auth  && getSubscription()->getData()->subscribed == true && checkInMovie($item) == true && isset($item->video_link))
                            ...
                            @if($item->trailer_url != null || $item->trailer_url != '')
                              <a href="{{ route('watchTrailer',$item->id) }}" class="watch-trailer-btn iframe btn-default">{{__('staticwords.watchtrailer')}}</a>
                            @endif
                          @else
                            @if($item->trailer_url != null || $item->trailer_url != '')
                              <a href="{{ route('guestwatchtrailer',$item->id) }}" class="watch-trailer-btn iframe btn-default">{{__('staticwords.watchtrailer')}}</a>
                            @endif
                          @endif
                          ...
                          @if($catlog ==0 && getSubscription()->getData()->subscribed == true)
                            ...
                            @if (isset($wishlist_check->added))
                              <a onclick="addWish({{$item->id}},'{{$item->type}}')" class="watch-trailer-btn addwishlistbtn{{$item->id}}{{$item->type}} btn-default">{{$wishlist_check->added == 1 ? __('staticwords.removefromwatchlist') : __('staticwords.addtowatchlist')}}</a>
                            @else
                              <a onclick="addWish({{$item->id}},'{{$item->type}}')" class="watch-trailer-btn addwishlistbtn{{$item->id}}{{$item->type}} btn-default">{{__('staticwords.addtowatchlist')}}</a>
                            @endif
                          @elseif($catlog ==1 && $auth)
                            @if (isset($wishlist_check->added))
                              <a onclick="addWish({{$item->id}},'{{$item->type}}')" class="watch-trailer-btn addwishlistbtn{{$item->id}}{{$item->type}} btn-default">{{$wishlist_check->added == 1 ? __('staticwords.removefromwatchlist') : __('staticwords.addtowatchlist')}}</a>
                      ...
                      <div id="prime-mix-description-block{{$item->id}}{{$item->type}}" class="prime-description-block">
                        ...
                        <div class="des-btn-block">
                          @if($auth && getSubscription()->getData()->subscribed == true)
                           ...
                           @endif
                           @if($item->trailer_url != null || $item->trailer_url != '')
                              <a href="{{ route('watchtvTrailer',$item->id)  }}" class="watch-trailer-btn iframe btn btn-default">{{__('staticwords.watchtrailer')}}</a>
                            @endif
                          @else
                             @if($item->trailer_url != null || $item->trailer_url != '')
                              <a href="{{ route('guestwatchtvtrailer',$item->id)  }}" class="watch-trailer-btn iframe btn btn-default">{{__('staticwords.watchtrailer')}}</a>
                            @endif
                          @endif
                          @if($catlog ==0 && getSubscription()->getData()->subscribed == true)
                            @if (isset($wishlist_check->added))
                              <a onclick="addWish({{$item->id}},'{{$item->type}}')" class="watch-trailer-btn addwishlistbtn{{$item->id}}{{$item->type}} btn-default">{{$wishlist_check->added == 1 ? __('staticwords.removefromwatchlist') : __('addtowatchlist')}}</a>
                            @else
                              <a onclick="addWish({{$item->id}},'{{$item->type}}')" class="watch-trailer-btn addwishlistbtn{{$item->id}}{{$item->type}} btn-default">{{__('staticwords.addtowatchlist')}}</a>
                            @endif
                          @elseif($catlog ==1 && $auth)
