@if(!in_array($id,['1','2','3']))
  <a href="{{ route('roles.edit',$id) }}" data-toggle="tooltip" data-original-title="{{__('adminstaticwords.Edit')}}" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
@else 
  <p class="text-danger">
