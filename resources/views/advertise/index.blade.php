...
@section('title',__('adminstaticwords.Advertise'))
@section('stylesheet')
<style>
...
<div class="box-header">
  <h5>{{__('adminstaticwords.Advertise')}}</h5>
</div>
    ...
    @endphp
        ...
        <a href="{{ route('ad.create') }}" class="btn btn-md btn-danger">+ {{__('adminstaticwords.CreateAD')}}</a>
      ...
      <div id="bulk_delete" class="delete-modal modal fade" role="dialog">
        ...
        <table id="full_detail_table" class="table table-hover">
            <thead>
                ...
                <th>#</th>
                <th>{{__('adminstaticwords.AdType')}}</th>
                <th>{{__('adminstaticwords.AdLocation')}}</th>
            ...
            <tbody>
                ...
                <td>
                 ...
                 <td><a href="{{ route('ad.edit',$ad->id) }}" class="btn btn-sm btn-success">{{__('adminstaticwords.Edit')}}</a></td>
                 <td>
