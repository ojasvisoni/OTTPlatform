            ...
            <div class="row panel-setting-main-block">
                <div class="col-md-6 col-sm-12">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{$plan->interval}} @if(Session::has('current_currency')) ({{ currency($plan->amount, $from = $plan->currency, $to = Session::has('current_currency') ? ucfirst(Session::get('current_currency')) : $plan->currency, $format = true) }} {{ __('equivalent to your currency')}}) @endif
                                        </td>
                                    </tr>
                                    @endif
                                </table>
                    ...
                    <ul class="nav nav-tabs tabs-left sideways payment-sideways">
                        ...
                        <!-- payhere tab -->
                        <li><a href="#payhere" data-toggle="tab">{{ __('staticwords.CheckoutWith') }} PayHere</a></li>
                        <!-- payhere end tab -->
                        @endif
                        <!-- coinpayment tab -->
                        ...
                        <li><a href="#wallet" data-toggle="tab">{{ __('staticwords.CheckoutWith') }} {{ __('Wallet') }}</a></li>
                        @endif
                        <!-- AuthorizeNet tab -->
...
<!--                    <form action="{{route('coupon.apply')}}" method="POST">
                    ...
                    <div class="tab-content payment-tab-content">
                        ...
                        <div class=" row tab-pane" id="cashfree">
                            ...
                            @else
                            <p class="text-danger">{{__('Please filled your mobile no')}}. <a href="{{url('/account/profile')}}">{{__('clickhere')}}</a></p>
                            @endif
                            @else
                            @component('components.alert')
                            Cashfree
                        ...
                        <div class="tab-pane" id="wallet">
                            ...
                            <form method="POST" action="{{ route('checkout.with.wallet') }}">
                                ...
                                <input class="form-control col-md-6" name="email" value="{{auth()->user()->email}}" type="hidden" placeholder="Your Email" />
                                <button class="payment-btn">{{ __('paynow') }}</button>
                            </form>
                            @else
...
<script src="{{url('js/stripe_v3.js')}}"></script>
<script>
    var style = {
        base: {
            color: '#32325d',
