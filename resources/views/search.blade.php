...
<section class="main-wrapper main-wrapper-single-movie-prime">
    <div class="container-fluid moive-cast">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-9 col-lg-10">
                    <div class="movie-series-section search-actor">
                        ...
                        <p>
                            {{__('staticwords.dob')}}- <span style="color: #f13e66;">{{$actor->DOB ? $actor->DOB : __('Not Available') }} </span>
                        </p>
                        <p>
                            {{__('staticwords.placeofbirth')}}- <span style="color: #f13e66;">{{$actor->place_of_birth ? $actor->place_of_birth : __('Not Available')}}</span> 
                        </p>
                        <p>
                            {{$actor->biography}}
                        </p>
        ...
        <h5 class="movie-series-heading moive-cast-heading">{{count($filter_video)}} {{__('staticwords.foundfor')}} "{{$searchKey}}"</h5>
        @endif
        @if(isset($director))
                ...
                <div class="col-lg-10 col-md-10 col-sm-9">
                    <div class="movie-series-section search-actor">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <ul class="movie-series-des-list">
                                    <li>
                                        @if($item->type == 'M')
                                        @if($item->duration != NULL) {{$item->duration}} {{__('staticwords.mins')}}@endif
                                        @else
                        ...
                        <div class="des-btn-block des-in-list">
                            ...
                            <div class="des-btn-block des-in-list">
                                @if($item->trailer_url != null || $item->trailer_url != '')
                                <a href="{{ route('guestwatchtrailer',$item->id) }}" class="iframe btn btn-default green-bg">{{__('staticwords.watchtrailer')}}</a>
                                @endif
                            </div>
                            @endif
                        </div>
