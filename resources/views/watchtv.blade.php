...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>{{__('staticwords.WatchTrailer')}} - {{ $season['tvseries']['title'] }}</title>
	...
	<body style="background-color:#999999; padding:0px; margin:0px;">	
        ...
        <p class="minimalDarkCategoriesDescription"><span class="minimialDarkBold">{{__('staticwords.description')}}: </span>{{ $season->detail }}</p>
      	</li>
		...
		<ul id="trailer">
			...
			<li data-subtitle-soruce="[{source:'{{ url('subtitles/english_subtitle.txt') }}', label:'English'}]" data-thumb-source="{{asset('images/movies/thumbnails/'.$season->thumbnail)}}" data-video-source="{{ $url }}" data-downloadable="yes" data-poster-source="{{asset('images/movies/posters/'.$season->poster)}}"> 
			    <div data-video-short-description="">
			    	 <p class="minimalDarkCategoriesTitle"><span class="minimialDarkBold">{{__('staticwords.title')}}: </span>{{ $season['title'] }}</p>
        <p class="minimalDarkCategoriesDescription"><span class="minimialDarkBold">{{__('staticwords.description')}}: </span>{{ $season['title'] }}</p>
			    </div>
			</li>
		</ul>
