          		...
          		<div class="card-body" id="stepbox">
                    ...
                    <form class="needs-validation" action="{{ url('/change-domain') }}" method="POST" novalidate>
                      ...
                      <div class="form-group">
                        ...
                        <small class="text-muted">
                          <i class="fa fa-question-circle"></i> {{__('IF still facing the access denied error please con')}} <a target="_blank" href="https://codecanyon.net/item/emart-laravel-multivendor-ecommerce-advanced-cms/25300293/support">{{ __('Support') }}</a> {{ __('for updation in domain.') }}.
                        </small>
