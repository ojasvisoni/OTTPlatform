										...
										<td>
											<div class="row">
												<div class="col-lg-6 col-xs-6">
													<input type="password" name="password" id="{{$item->title}}" value="{{isset($item->password) && $item->password != NULL ? Crypt::decrypt($item->password) : ''}}" class="password protected-feild" disabled="disabled">
												</div>
