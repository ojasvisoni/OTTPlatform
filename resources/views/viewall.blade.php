                    ...
                    <form action="" method="get" class="filterForm">
                        <div class="movie-series-sidebar">
                            ...
                            <div class="reset-filter-block">
                                <button type="submit" class="btn btn-primary btn-default green-bg"><i class="fa fa-sync"></i>{{__('staticwords.ApplyFilters')}}</button> 
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="row viewallmoive">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6">
                            <div class="movie-series-image protip" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block{{$item['seasons_first']['id']}}{{ $item['seasons_first']['type'] }}">
                                ...
                                <div class="hide-icon hide-icon-two">
                                    <a onclick="hideforme('{{$item['seasons_first']['id']}}','{{$item['seasons_first']['type']}}')" title="{{__('Hide this Movie')}}" class=""><i class="fa fa-ban"></i></a>
                                </div>
                                @else
