  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body age-modal-body">
        <h6 style="color: #f13e66; font-size: 16px;"><?php echo e(__('staticwords.foragerestricttext')); ?></h6><br>
        <div class="row">
            <div class="col-md-8">
...
</div><?php /**PATH /var/www/html/oovmedia.starpankaj.com/resources/views/modal/agemodal.blade.php ENDPATH**/ ?>