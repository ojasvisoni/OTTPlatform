...
<!--                        <h4 class="plan-dtl-sub-heading"><?php echo e(__('staticwords.membershipline')); ?></h4>-->
                        <div class="plan-dtl-list">
                            <ul>
                                <li><?php echo e(__('staticwords.membershipline')); ?></li>
                    ...
                    <div class="snip1404 row">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="main-plan-section  <?php if(isset($current_subscription) && $current_subscription->package_id == $plan->id): ?> main-plan-section-two <?php endif; ?>">
                                ...
                                <div class="plan-select"><a class="btn btn-prime green-bg"><?php echo e(__('staticwords.alreadysubscribe')); ?> </a></div>
                                <div class="plan-select"><a href="<?php echo e(route('resumeSubPaypal')); ?>" class="btn btn-prime red-bg"><?php echo e(__('staticwords.resumesubscription')); ?></a></div>
                                <?php else: ?>
                                <?php if(!isset($current_subscription) && $current_subscription == NULL): ?>
                                <?php if($plan->free == 1 && $plan->status == 'upcoming'): ?>
                                <div class="plan-select"><a href="#" class="btn btn-prime green-bg"><?php echo e(__('COMING SOON!')); ?></a></div>
                                <?php elseif($plan->free == 1 && $plan->status == 'active'): ?>
                                <form action="<?php echo e(route('free.package.subscription',$plan->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="plan-select btn-prime-subs"><a class="btn btn-prime green-bg"><input type="submit" class="btn-subscribe" value="<?php echo e(__('staticwords.subscribe')); ?>"></a></div>
                                </form>
                                <?php elseif($plan->status == 'upcoming'): ?>
                                <div class="plan-select"><a href="#" class="btn btn-prime green-bg"><?php echo e(__('COMING SOON!')); ?></a></div>
                                <?php else: ?>
                                <div class="plan-select"><a href="<?php echo e(route('get_payment', $plan->id)); ?>" class="btn btn-prime green-bg"><?php echo e(__('staticwords.subscribe')); ?></a></div>
                                <?php endif; ?>
                                <?php endif; ?>
                                <?php endif; ?>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/oovmedia.starpankaj.com/resources/views/user/purchaseplan.blade.php ENDPATH**/ ?>