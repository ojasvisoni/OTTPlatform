<div class="admin-table-action-block">
  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('menu.edit')): ?>
    <a href="<?php echo e(route('menu.edit', $id)); ?>" data-toggle="tooltip" data-original-title="<?php echo e(__('adminstaticwords.Edit')); ?>" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
  <?php endif; ?>
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form method="POST" action="<?php echo e(route("menu.destroy", $id)); ?>">
...
</div><?php /**PATH /var/www/html/oovmedia.com/resources/views/admin/menu/action.blade.php ENDPATH**/ ?>