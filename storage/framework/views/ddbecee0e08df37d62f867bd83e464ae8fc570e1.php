...
<section class="main-wrapper main-wrapper-single-movie-prime">
    <div class="container-fluid moive-cast">
        <?php if(isset($actor)): ?>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-9 col-lg-10">
                    <div class="movie-series-section search-actor">
                        ...
                        <p>
                            <?php echo e(__('staticwords.dob')); ?>- <span style="color: #f13e66;"><?php echo e($actor->DOB ? $actor->DOB : __('Not Available')); ?> </span>
                        </p>
                        <p>
                            <?php echo e(__('staticwords.placeofbirth')); ?>- <span style="color: #f13e66;"><?php echo e($actor->place_of_birth ? $actor->place_of_birth : __('Not Available')); ?></span> 
                        </p>
                        <p>
        ...
        <h5 class="movie-series-heading moive-cast-heading"><?php echo e(count($filter_video)); ?> <?php echo e(__('staticwords.foundfor')); ?> "<?php echo e($searchKey); ?>"</h5>
        <?php endif; ?>
        <?php if(isset($director)): ?>
        <div class="movie-series-block moive-series-100">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-10 col-sm-9">
                    <div class="movie-series-section search-actor">
                        ...
                        <p>
                            <?php echo e(__('staticwords.dob')); ?>- <?php echo e($director->DOB); ?> 
                        </p>
                        <p>
                            <?php echo e(__('staticwords.placeofbirth')); ?>- <?php echo e($director->place_of_birth); ?>
                ...
                <div class="col-lg-10 col-md-10 col-sm-9">
                    <div class="movie-series-section search-actor">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <ul class="movie-series-des-list">
                                    <li>
                                        <?php if($item->type == 'M'): ?>
                                        <?php if($item->duration != NULL): ?> <?php echo e($item->duration); ?> <?php echo e(__('staticwords.mins')); ?><?php endif; ?>
                                        <?php else: ?>
                        ...
                        <div class="des-btn-block des-in-list">
                            ...
                            <div class="des-btn-block des-in-list">
                                <?php if($item->trailer_url != null || $item->trailer_url != ''): ?>
                                <a href="<?php echo e(route('guestwatchtrailer',$item->id)); ?>" class="iframe btn btn-default green-bg"><?php echo e(__('staticwords.watchtrailer')); ?></a>
                                <?php endif; ?>
                            </div>
                            <?php endif; ?>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/oovmedia.starpankaj.com/resources/views/search.blade.php ENDPATH**/ ?>