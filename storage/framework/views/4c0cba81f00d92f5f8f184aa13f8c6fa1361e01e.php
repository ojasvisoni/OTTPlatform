...
<div class="genre-prime-block showalllangs">
    <div class="container-fluid">
        <h5 class="section-heading"><?php echo e(__('staticwords.viewallin')); ?> <?php echo e($alang->language); ?></h5>
        <div class="row">
            ...
            <div class="col-lg-2 col-md-3 col-xs-6 col-sm-4">
                <div class="cus_img">
                    <div class="genre-slide-image home-prime-slider protip" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block<?php echo e($item->tvseries->id); ?><?php echo e($item->tvseries['type']); ?>">
                        <?php if($auth && getSubscription()->getData()->subscribed == true): ?>
                        <a href="<?php echo e(url('show/detail',$item->season_slug)); ?>">
                        <?php if($src): ?>
                        <img data-src="<?php echo e($src); ?>" class="img-responsive lazy" alt="genre-image">
                        <?php else: ?>
                        <img data-src="<?php echo e(Avatar::create($item->tvseries->title)->toBase64()); ?>" class="img-responsive lazy" alt="genre-image">
                        <?php endif; ?>
                        </a>
                        <div class="hide-icon hide-icon-two">
                            <a onclick="hideforme('<?php echo e($item['id']); ?>','<?php echo e($item['type']); ?>')" title="<?php echo e(__('Hide this Movie')); ?>" class=""><i class="fa fa-ban"></i></a>
                    ...
                    <?php if(isset($protip) && $protip == 1): ?>
                    <div id="prime-next-item-description-block<?php echo e($item->tvseries->id); ?><?php echo e($item['tvseries']['type']); ?>" class="prime-description-block">
                        ...
                        <ul class="description-list">
                            ...
                            <li><?php echo e($item->tvseries->publish_year); ?></li>
                            <li><?php echo e($item->tvseries->age_req); ?></li>
                            <?php if($item->tvseries->subtitle == 1): ?>
                            <li>
                                <?php echo e(__('staticwords.subtitles')); ?>
                        ...
                        <div class="main-des">
                            <?php if($item->tvseries->detail != null || $item->tvseries->detail != ''): ?>
                        ...
                        <div class="des-btn-block">
                            ...
                            <?php if($catlog ==0 && getSubscription()->getData()->subscribed == true): ?>
                            <?php if(isset($wishlist_check->added)): ?>
                            <a onclick="addWish(<?php echo e($item['id']); ?>,'<?php echo e($item->tvseries['type']); ?>')" class="addwishlistbtn<?php echo e($item['id']); ?><?php echo e($item->tvseries['type']); ?> btn-default"><?php echo e($wishlist_check->added == 1 ? __('staticwords.removefromwatchlist') : __('staticwords.addtowatchlist')); ?></a>
                            <?php else: ?>
                            <a onclick="addWish(<?php echo e($item->id); ?>,'<?php echo e($item->tvseries['type']); ?>')" class="addwishlistbtn<?php echo e($item->id); ?><?php echo e($item->tvseries['type']); ?> btn-default"><?php echo e(__('staticwords.addtowatchlist')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/oovmedia.starpankaj.com/resources/views/showallalang.blade.php ENDPATH**/ ?>