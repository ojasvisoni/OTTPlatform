                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mobile-view">
                        <div class="poster-thumbnail-block home-prime-slider">
                            ...
                            <a href="<?php echo e(route('watchmovieiframe',$movie->id)); ?>" class="btn btn-play iframe mobile-play-btn"><span class="play-btn-icon"><i class="fa fa-play"></i></span> </a>
                                <?php else: ?>
                            <a href="<?php echo e(route('watchmovie',$movie->id)); ?>" class="btn btn-play iframe mobile-play-btn"><span class="play-btn-icon"><i class="fa fa-play"></i></span> </a>
                            <?php endif; ?>
                            <?php else: ?>
                            <a onclick="myage(<?php echo e($age); ?>)" class="btn btn-play iframe mobile-play-btn"><span class="play-btn-icon"><i class="fa fa-play"></i></span> </a>
                            <?php endif; ?>
                            <?php endif; ?>
                            <?php endif; ?>
                            <?php endif; ?>
                    ...
                    <div class="col-md-8">
                        <div class="full-movie-dtl-block">
                            ...
                            <div class="imdb-ratings-block">
                                <ul>
                                    <?php if(isset($movie->publish_year)): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php endif; ?>
                                    <?php if(isset($movie->maturity_rating)): ?>
...
<!--                                    <li>
                                        <div class="dropdown rating-dropdown">
                                            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-star"></i> <?php echo e(__('Rate Movie')); ?>
                            ...
                            <div id="wishlistelement" class="screen-play-btn-block ">
                                ...
                                <?php if($movie->maturity_rating == 'all age' || $age>=str_replace('+', '',$movie->maturity_rating)): ?>
                                <?php if(isset($movie->video_link['iframeurl']) && $movie->video_link['iframeurl'] != null): ?>
                                <a href="<?php echo e(route('watchmovieiframe',$movie->id)); ?>"class="btn btn-play iframe desktop-play-btn"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text"><?php echo e(__('staticwords.playnow')); ?></span>
                                </a>
                                <?php else: ?>
                                <a href="<?php echo e(route('watchmovie',$movie->id)); ?>" class="iframe btn btn-play desktop-play-btn"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text"><?php echo e(__('staticwords.playnow')); ?></span>
                                </a>
                                <?php endif; ?>
                                <?php else: ?>
                                <a onclick="myage(<?php echo e($age); ?>)"  class=" btn btn-play"><span class="play-btn-icon desktop-play-btn"><i class="fa fa-play"></i></span> <span class="play-text"><?php echo e(__('staticwords.playnow')); ?></span>
                                </a>
                                <?php endif; ?>
                                <?php endif; ?>
                                <?php endif; ?>
                                ...
                                <button type="button" class="btn btn-default watch-trailer-btn" data-toggle="collapse" data-target="#downloadmovie"><?php echo e(__('staticwords.download')); ?></button>
                                    ...
                                    <table  class=" text-center table table-bordered table-responsive detail-multiple-link">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a data-id="<?php echo e($link->id); ?>" class="download btn btn-sm btn-success" title="<?php echo e(__('staticwords.download')); ?>" href="<?php echo e($link->url); ?>" >
                    ...
                    ?>
                    <div class="col-md-4 desktop-views">
                        <div class="poster-thumbnail-block home-prime-slider">
                            <img data-src="<?php echo e($src); ?>" class="img-responsive lazy" alt="genre-image">
                        </div>
                    </div>
    ...
    <div class="container-fluid movie-series-section search-section">
        ...
        <div>
            ...
            if($single_series->thumbnail != NULL){
            $content = @file_get_contents(public_path() . '/images/movies/thumbnails/' . $single_series->thumbnail);
            if($content){
            $image = '/images/movies/thumbnails/'.$single_series->thumbnail;
            }else{
            $image = '/images/default-thumbnail.jpg';
            }
            }else{
                    ...
                    <div class="col-lg-10">
                        <div class="movie-series-section">
                            ...
                            <div class="des-btn-block des-in-list">
                                ...
                                <?php if(Auth::user() && getSubscription()->getData()->subscribed == true): ?>
                                <?php if(in_array(1, $mlc)): ?>
                                <button type="button" class="btn btn-sm btn-default watch-trailer-btn download-btn" data-toggle="collapse" data-target="#downloadmovie<?php echo e($single_series->id); ?>"><?php echo e(__('staticwords.download')); ?></button>
    ...
    $content = @file_get_contents(public_path() . '/images/movies/thumbnails/' . $series->thumbnail);
    if($content){
    $image = '/images/movies/thumbnails/'.$series->thumbnail;
    }else{
    $image = '/images/default-thumbnail.jpg';
    }
    }else{
    ...
    <?php else: ?>
    <a href="<?php echo e(route('watchmovie',$series->id)); ?>" class="iframe watch-trailer-btn btn btn-play"><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text"><?php echo e(__('staticwords.playnow')); ?></span>
    </a>
    <?php endif; ?>
    <?php else: ?>
    <a onclick="myage(<?php echo e($age); ?>)"  class=" btn btn-play "><span class="play-btn-icon"><i class="fa fa-play"></i></span> <span class="play-text"><?php echo e(__('staticwords.playnow')); ?></span>
    ...
    <a href="<?php echo e(route('watchTrailer',$series->id)); ?>" class="watch-trailer-btn iframe btn btn-default"><?php echo e(__('staticwords.watchtrailer')); ?></a>
    <?php endif; ?>
    <?php else: ?>
    <?php if($series->trailer_url != null || $series->trailer_url != ''): ?>
    <a href="<?php echo e(route('guestwatchtrailer',$series->id)); ?>" class="watch-trailer-btn iframe btn btn-default"><?php echo e(__('staticwords.watchtrailer')); ?></a>
    <?php endif; ?>
    <?php endif; ?>
    <?php if($catlog ==0 && getSubscription()->getData()->subscribed == true): ?>
    <?php if(isset($wishlist_check->added)): ?>
    ...
    <?php if(Auth::user() && getSubscription()->getData()->subscribed == true): ?>
    <?php if(in_array(1, $mlc)): ?>
    <button type="button" class="btn btn-sm btn-default download-btn watch-trailer-btn" data-toggle="collapse" data-target="#downloadmovie<?php echo e($series->id); ?>"><?php echo e(__('staticwords.download')); ?></button>
    ...
    $content = @file_get_contents(public_path() . '/images/tvseries/episodes/' . $episode->thumbnail);
    if($content){
    $image = '/images/tvseries/episodes/'.$episode->thumbnail;
    }else{
    $image = '/images/default-thumbnail.jpg';
    }
    }else{
    ...
    <button type="button" class="btn btn-default download-btn watch-trailer-btn" data-toggle="collapse" data-target="#downloadtvseries<?php echo e($episode->id); ?>"><?php echo e(__('staticwords.download')); ?></button>
    ...
    <div class="container-fluid movie-series-section comment-nav-tabs">
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade in active" id="showcomment">
                ...
                <?php else: ?>
                <h4 class="title" style="color:#B1B1B1;"><span class="glyphicon glyphicon-comment"></span> <?php echo e($season->tvseries->comments->where('status',1)->count()); ?> <?php echo e(__('staticwords.comment')); ?> </h4>
                <br/>
            ...
            <div role="tabpanel" class="tab-pane fade" id="postcomment">
                <div style="width: 90%;color:#B1B1B1;" class=" " >
                    <h3><?php echo e(__('staticwords.postcomment')); ?>:</h3>
                    <br/>
    ...
    <div class="genre-prime-block">
        <div class="container-fluid">
            ...
            <div class="genre-prime-slider owl-carousel">
                ...
                ?>
                <?php if(isset($movie)): ?>
                <div class="genre-prime-slide owls-item m-box">
                    ...
                    <div class="hidden-content">
                        ...
                        <div class="action-btn-wrap">
                            ...
                            <a href="https://oovmedia.starpankaj.com/watch/movie/21" class="btn btn-primary btn-bordered addto-watchlist">Play Now
                            </a>
                            </span>
                            <span class="play-button-wrap">
                            <a class="iframe btn btn-primary cboxElement" href="https://oovmedia.starpankaj.com/watch/21">Watch Trailer</a>
                            </span>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="genre-main-slider owl-carousel">
                        ...
                        }elseif($item->tvseries->thumbnail){
                        $content = @file_get_contents(public_path() . '/images/tvseries/thumbnails/' . $item->tvseries->thumbnail);
                        if($content){
                        $image = public_path() .'/images/tvseries/thumbnails/'.$item->tvseries->thumbnail;
                        }else{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/oovmedia.starpankaj.com/resources/views/movie_single_prime.blade.php ENDPATH**/ ?>