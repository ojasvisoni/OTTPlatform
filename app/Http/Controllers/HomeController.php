...
//old code here
        ...
        if ($removelanding == 1 && $catlog == 1) {
            ...
            if ($catlog == 1 && $withlogin == 0) {
                ...
                $menuh = Menu::get();
                return view('main', compact('getallgenre', 'menu_data', 'recent_data', 'ad', 'age', 'genres', 'menuh', 'catlog', 'withlogin', 'menu', 'subscribed',  'audiolanguages', 'section6', 'blogs', 'liveevent', 'home_slides', 'age','audio','short_promo','audio_lang','upcomingitems','getallaudiolanguage','top_data','pricingTexts', 'plans', 'blocks', 'menuh', 'catlog', 'withlogin', 'package_feature'));
            } else if ($catlog == 1 && $withlogin == 1) {
                ...
                return view('main', compact('getallgenre', 'menu_data', 'recent_data', 'ad', 'age', 'genres', 'menuh', 'catlog', 'withlogin', 'menu', 'subscribed',  'audiolanguages', 'section6', 'blogs', 'liveevent', 'home_slides', 'age','audio','short_promo','audio_lang','upcomingitems','getallaudiolanguage','top_data','pricingTexts', 'plans', 'blocks', 'catlog', 'withlogin', 'package_feature'));
            }
        }
    }
